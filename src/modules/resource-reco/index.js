 ...
 * news/institutional tavsiyasi; LLM faqat retrieved recordlarni
 * rank/summarize qiladi (hallucination guard §11.4).
 */

export * from './resource-reco.schema.js';
export * from './resource-reco.service.js';
